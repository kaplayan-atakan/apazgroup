        ...
        <div class="container">
            <div class="s_blog_text_inner video_s_blog pb-0">
                <div class="blog_main_text">
                    <h5>Baydöner’e iki kardeş geldi: Pidebypide ve Bursa İshakbek</h5>

                    <div class="row">
                        <div class="col-md-6 py-2">
                            <p>
                                <img class="img-fluid my-2" src="img/haber-4-420x220.png"><br>
                            </p>
                        </div>
                        <div class="col-md-6 py-2">
                            <p>
                                ...
                                DeFacto’da Hulusi Derici ve ajansı M.A.R.K.A. ile oldukça başarılı iş birliklerine imza attınız. BayDöner’de yeniden birliktesiniz. Öncelikle dilerseniz bir DeFacto sürecini konuşalım…<br><br>
                                ...
                                BayDöner ile yine M.A.R.K.A. reklam ajansıyla çalışıyorsunuz. Bu süreç nasıl başladı?<br><br>
                                <br>
